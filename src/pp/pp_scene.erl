...
handle(12001, Status, [X, Y]) ->
    ...
    lib_scene:move_broadcast(Status#player_status.scene, X, Y, Status#player_status.x, Status#player_status.y, BinData,
        BinData1, BinData2, Status#player_status.socket),
    %%坐骑扣除
