...
-record(goods, {
        ...
        use_num=0,      %% 可使用次数，由lib_goods:get_goods_max_use_num(Attrition)算得
        suit_id=0,      %% 套装ID，0为无
...
-define(GOODS_LOCATION_FIRST, 1).
-define(GOODS_LOCATION_SECOND, 2).
-define(GOODS_LOCATION_THIRD, 3).
-define(GOODS_LOCATION_BAG, 4).
-define(GOODS_LOCATION_STORAGE, 5).
